...
class GetUpdateDelete(Resource):
    #GET particular user using user_id
    def get(self, idx):
...
def enrollment():
    ...
    if courseID:
        if Enrollment.objects(user_id=user_id, courseID=courseID):
            ...
            flash(f"You are enrolled in the course: {courseTitle}!", "success")
...
def courses(term=None):
    if term is None:
        term = "Spring 2021"
    classes = Course.objects.order_by("courseID") # for reverse sort put minus sign here
...
def user():
    ...
    #     first_name="akshat",
    #     last_name="shah",
    #     email="akshat.33@uta.com",
    #     password="abc1234"
    # ).save()
    # User(user_id=2,
    #     first_name="omi",
    #     last_name="yugi",
    #     email="omi.23@uta.com",
    #     password="1234"
    # ).save()
